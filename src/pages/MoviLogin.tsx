      ...
      <div className="relative min-h-screen flex flex-col overflow-hidden">
        ...
        <div className="relative z-10 flex flex-1 min-h-screen">
          ...
          <div className="hidden lg:flex lg:w-[52%] xl:w-[55%] flex-col items-start justify-between px-16 xl:px-24 py-14">
            ...
            <div className="max-w-md">
              ...
              <div className="mt-10 space-y-4">
                {[
                  { label: 'CRM y tramites integrados' },
                  { label: 'Sincronizacion con SICAS en tiempo real' },
                  { label: 'Reportes de produccion y comisiones' },
                ].map((item, i) => (
          ...
          <div className="flex-1 flex flex-col items-center justify-center px-6 py-12 lg:px-14 xl:px-20">
              ...
              <form onSubmit={handleSubmit} className="space-y-4" noValidate>
                ...
                <button
                  ...
                  style={{
                    background: loading
                      ? 'rgba(13,110,253,0.5)'
                      : 'linear-gradient(135deg, #0D6EFD, #0047bb)',
            ...
            {/* Mobile footer */}
            <div className="lg:hidden mt-12 text-[11px]"
