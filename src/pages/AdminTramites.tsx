...
import {
  ...
  ToggleLeft, ToggleRight, ChevronDown, FileText, Lock, Route,
} from 'lucide-react';
...
import { AsignacionPorTramite } from '../components/tramites/AsignacionPorTramite';

// ─── Types ────────────────────────────────────────────────────────────────────

type TabId = 'areas' | 'tipos' | 'equipos' | 'permisos' | 'reglas' | 'asignacion';
...
const TABS: { id: TabId; label: string; icon: React.ElementType; desc: string }[] = [
  ...
  { id: 'asignacion',  label: 'Asignación por Trámites', icon: Route, desc: 'Override manual agente + tipo' },
];
  ...
  return (
    <div className="p-6 sm:p-8 max-w-6xl mx-auto space-y-6">
      ...
      <div>
        ...
        {tab === 'asignacion'  && <AsignacionPorTramite />}
      </div>
    </div>
  );
}
