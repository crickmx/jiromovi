...
export function CentroNotificacionesContent() {
  ...
  const handleEnviar = async () => {
    ...
    try {
      ...
      if (result.success) {
        showToast('Notificacion enviada exitosamente', 'success');
        setFormData({
          titulo: '',
          mensaje: '',
          accion_url: '',
              ...
              <div className={`flex items-start gap-3 p-3 border rounded-lg transition-colors ${
                ...
                <div className="flex-1">
                  ...
                  <p className={`text-xs mt-1 ${
                    ...
                    {formData.enviar_whatsapp
                      ? 'Se enviara el mensaje por WhatsApp a todos los usuarios que tengan numero de telefono'
                      : 'Marca esta opcion para enviar el mensaje tambien por WhatsApp'
                    }
                  </p>
                </div>
              </div>
            ...
            <div className="space-y-4">
              {historial.map((notif) => (
                ...
                >
                  ...
                  <p className="text-sm text-neutral-600 dark:text-neutral-400 mb-3">{notif.mensaje}</p>
