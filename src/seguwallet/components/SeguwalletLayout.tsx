...
// On app.seguwallet.mx routes are /dashboard, /polizas, etc.
// On app.movi.digital they are /seguwallet/dashboard, /seguwallet/polizas, etc.
const SW_PREFIX = typeof window !== 'undefined' && window.location.hostname.endsWith('.seguwallet.mx')
  ? ''
  : '/seguwallet';
