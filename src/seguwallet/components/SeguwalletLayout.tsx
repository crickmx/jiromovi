    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-blue-50/20">
      ...
      <header className="sticky top-0 z-40 bg-white/90 backdrop-blur-xl border-b border-neutral-100/80 shadow-[0_1px_3px_rgba(0,0,0,0.03)]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex items-center justify-between h-16">
          ...
          <button onClick={() => navigate('/seguwallet/dashboard')} className="flex items-center">
            <img src={logoLight} alt="Seguwallet" className="h-8 w-auto object-contain" />
          </button>
          ...
          <div className="flex items-center gap-3">
            <div className="hidden sm:flex items-center gap-2">
              <div className="w-8 h-8 rounded-full bg-[#1C37E0] flex items-center justify-center text-white text-xs font-bold uppercase">
                {getInitials()}
              </div>
      ...
      <footer className="border-t border-neutral-100 py-6 mt-8">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex items-center justify-between">
          <img src={logoLight} alt="Seguwallet" className="h-5 w-auto object-contain opacity-70" />
