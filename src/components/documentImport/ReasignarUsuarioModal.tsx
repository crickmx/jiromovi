        ...
        <div className="p-4 sm:p-6">
          <div className="bg-blue-50 border border-blue-200 rounded-xl p-4 mb-6">
            <div className="flex items-start gap-3">
              ...
              <div className="flex-1 min-w-0">
                <p className="font-semibold text-blue-900">Usuario actual</p>
                <p className="text-sm text-blue-800 mt-1">{group.user_name}</p>
                <p className="text-xs text-blue-700 mt-0.5">{group.user_email}</p>
          ...
          <div className="flex flex-col sm:flex-row justify-end gap-3">
            ...
            <button
              ...
              className="w-full sm:w-auto px-6 py-3 bg-blue-600 text-white rounded-xl hover:bg-blue-700 transition disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2 font-semibold min-h-[44px]"
            >
              {loading ? (
                <>
