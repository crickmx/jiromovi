      ...
      <div className="bg-white dark:bg-gray-800 rounded-xl shadow-2xl w-full max-w-3xl my-4">
        ...
        <form onSubmit={handleSubmit} className="p-4 space-y-4">
            ...
            <div className="bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800 rounded-lg p-3">
              <ul className="list-disc list-inside space-y-1">
                {errors.map((error, index) => (
                  <li key={index} className="text-red-700 dark:text-red-400 text-xs">
                    {error}
                  </li>
                ))}
              </ul>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              >
                ...
                {tramiteTypes
                  .filter(type => {
                    ...
                    return nombre.includes('cotizaci') && nombre.includes('emisi') || nombre === 'otro';
                  })
                  .map(type => (
            ...
            <div>
              ...
              <select
                ...
                className="w-full px-3 py-2 text-sm border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-blue-500 dark:bg-gray-700 dark:text-white disabled:bg-gray-100 dark:disabled:bg-gray-800 disabled:cursor-not-allowed"
                required
              ...
              {!attendingUserId && (
                <p className="text-xs text-gray-500 dark:text-gray-400 mt-1">
                  Seleccione "Quién Atiende" primero
                </p>
              )}
          ...
          <div className="relative">
            ...
            <div
              className="w-full px-3 py-2 text-sm border border-gray-300 dark:border-gray-600 rounded-lg cursor-pointer dark:bg-gray-700 dark:text-white"
              ...
              <div className="absolute z-10 w-full mt-1 bg-white dark:bg-gray-700 border border-gray-300 dark:border-gray-600 rounded-lg shadow-lg max-h-48 overflow-auto">
                ...
                <div className="p-1">
                  {filteredAseguradoras.map(aseg => (
                    <label
                      key={aseg.id}
                      className="flex items-center gap-2 p-1.5 hover:bg-gray-100 dark:hover:bg-gray-600 rounded cursor-pointer"
                    >
                      <input
                        type="checkbox"
