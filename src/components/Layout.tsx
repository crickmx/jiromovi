...
export function Layout({ children, hideHeader = false }: LayoutProps) {
  ...
  const navItems = [
    ...
    { path: isAdmin ? '/comisiones' : '/mis-comisiones', label: 'Comisiones', icon: DollarSign, show: !isEmpleado },
    { path: '/mi-produccion', label: 'Mi Producción', icon: TrendingUp, show: isAgente },
    { path: '/mi-produccion-sicas', label: 'Mi Producción SICAS', icon: Database, show: !isEmpleado },
    ...
    { path: '/mi-progreso', label: 'Mi Progreso', icon: Trophy, show: !isEmpleado },
