...
const WORKSPACE_ADMIN: WorkspaceDefinition = {
  ...
  items: [
    ...
    { path: '/admin/seguros-express', label: 'Seguros Express', icon: Zap, visibleTo: ADMIN_ONLY },
