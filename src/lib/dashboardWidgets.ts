...
export const WIDGET_REGISTRY: WidgetDefinition[] = [
  ...
  // ── CP Summary ──
  { id: 'centro_produccion', label: 'Centro de Producción', description: 'Resumen de producción, comisiones, cobranza y renovaciones', allowedRoles: ALL_ROLES, defaultWidth: 'full', allowedWidths: ['full', 'half'], icon: 'TrendingUp', category: 'kpi' },
...
export const DEFAULT_LAYOUT: Record<UserRole, WidgetConfig[]> = {
  Administrador: [
    ...
    { widget_id: 'centro_produccion',     visible: true, position: 1,  width: 'full',  custom_settings: {} },
    { widget_id: 'produccion_oficina',    visible: true, position: 2,  width: 'half',  custom_settings: {} },
    ...
    { widget_id: 'crm_tareas',           visible: true, position: 6,  width: 'third', custom_settings: {} },
    { widget_id: 'polizas_vigentes',     visible: true, position: 7,  width: 'third', custom_settings: {} },
    { widget_id: 'produccion_mensual',    visible: true, position: 8,  width: 'full',  custom_settings: {} },
    { widget_id: 'renovaciones_breakdown', visible: true, position: 9, width: 'half', custom_settings: {} },
    { widget_id: 'top_aseguradoras',     visible: true, position: 10, width: 'half',  custom_settings: {} },
    { widget_id: 'produccion_por_agente', visible: true, position: 11, width: 'half',  custom_settings: {} },
    { widget_id: 'actividad_reciente',    visible: true, position: 12, width: 'half',  custom_settings: {} },
    { widget_id: 'tramites_recientes',    visible: true, position: 13, width: 'half',  custom_settings: {} },
    { widget_id: 'comunicados_recientes', visible: true, position: 14, width: 'half',  custom_settings: {} },
    { widget_id: 'diagnostico_sistema',   visible: true, position: 15, width: 'half',  custom_settings: {} },
    { widget_id: 'accesos_rapidos',       visible: true, position: 16, width: 'full',  custom_settings: {} },
  ],
  Gerente: [
    { widget_id: 'chava_insights',        visible: true, position: 0,  width: 'full',  custom_settings: {} },
    { widget_id: 'centro_produccion',     visible: true, position: 1,  width: 'full',  custom_settings: {} },
    ...
    { widget_id: 'tramites_pendientes',   visible: true, position: 2,  width: 'third', custom_settings: {} },
    { widget_id: 'agentes_activos',       visible: true, position: 3,  width: 'third', custom_settings: {} },
    { widget_id: 'crm_tareas',           visible: true, position: 4,  width: 'third', custom_settings: {} },
    { widget_id: 'polizas_vigentes',     visible: true, position: 5,  width: 'third', custom_settings: {} },
    { widget_id: 'notificaciones_sin_leer', visible: true, position: 6, width: 'third', custom_settings: {} },
    { widget_id: 'produccion_mensual',    visible: true, position: 7,  width: 'full',  custom_settings: {} },
    { widget_id: 'renovaciones_breakdown', visible: true, position: 8, width: 'half', custom_settings: {} },
    { widget_id: 'top_aseguradoras',     visible: true, position: 9,  width: 'half',  custom_settings: {} },
    { widget_id: 'produccion_por_agente', visible: true, position: 10, width: 'half',  custom_settings: {} },
    { widget_id: 'tramites_recientes',    visible: true, position: 11, width: 'half',  custom_settings: {} },
    { widget_id: 'comunicados_recientes', visible: true, position: 12, width: 'half',  custom_settings: {} },
    { widget_id: 'accesos_rapidos',       visible: true, position: 13, width: 'full',  custom_settings: {} },
  ],
  Empleado: [
    { widget_id: 'chava_insights',        visible: true, position: 0,  width: 'full',  custom_settings: {} },
    { widget_id: 'centro_produccion',     visible: true, position: 1,  width: 'full',  custom_settings: {} },
    ...
    { widget_id: 'crm_tareas',           visible: true, position: 4,  width: 'third', custom_settings: {} },
    { widget_id: 'contactos',            visible: true, position: 5,  width: 'third', custom_settings: {} },
    { widget_id: 'notificaciones_sin_leer', visible: true, position: 6, width: 'third', custom_settings: {} },
    ...
    { widget_id: 'gamificacion',          visible: true, position: 10, width: 'half',  custom_settings: {} },
  ...
  Agente: [
    ...
    { widget_id: 'renovaciones_breakdown', visible: true, position: 8, width: 'half', custom_settings: {} },
    { widget_id: 'top_aseguradoras',     visible: true, position: 9,  width: 'half',  custom_settings: {} },
    { widget_id: 'tramites_recientes',    visible: true, position: 10, width: 'half',  custom_settings: {} },
    { widget_id: 'comunicados_recientes', visible: true, position: 11, width: 'half',  custom_settings: {} },
    { widget_id: 'gamificacion',          visible: true, position: 12, width: 'half',  custom_settings: {} },
    { widget_id: 'notificaciones_sin_leer', visible: true, position: 13, width: 'third', custom_settings: {} },
    { widget_id: 'accesos_rapidos',       visible: true, position: 14, width: 'full',  custom_settings: {} },
  ],
  Ejecutivo: [
    { widget_id: 'chava_insights',        visible: true, position: 0,  width: 'full',  custom_settings: {} },
    { widget_id: 'centro_produccion',     visible: true, position: 1,  width: 'full',  custom_settings: {} },
    ...
    { widget_id: 'renovaciones_breakdown', visible: true, position: 7, width: 'half', custom_settings: {} },
    { widget_id: 'top_aseguradoras',     visible: true, position: 8,  width: 'half',  custom_settings: {} },
    { widget_id: 'tramites_recientes',    visible: true, position: 9,  width: 'half',  custom_settings: {} },
    { widget_id: 'comunicados_recientes', visible: true, position: 10, width: 'half',  custom_settings: {} },
    { widget_id: 'gamificacion',          visible: true, position: 11, width: 'half',  custom_settings: {} },
    { widget_id: 'notificaciones_sin_leer', visible: true, position: 12, width: 'third', custom_settings: {} },
    { widget_id: 'accesos_rapidos',       visible: true, position: 13, width: 'full',  custom_settings: {} },
  ],
};
