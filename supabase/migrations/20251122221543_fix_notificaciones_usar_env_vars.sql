/*
  # Ajustar función para usar variables de entorno directamente

  1. Cambios
    - Usar las variables de entorno del sistema en lugar de current_setting
    - Construir URL directamente con valores conocidos
    - Simplificar llamada HTTP

  2. Notas
    - Las edge functions están en el mismo proyecto de Supabase
    - URL es predecible: {SUPABASE_URL}/functions/v1/{function_name}
*/

-- Recrear función usando variables de entorno directamente
