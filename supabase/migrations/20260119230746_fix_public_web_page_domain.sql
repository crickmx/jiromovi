/*
  # Corregir Dominio en Función de Páginas Públicas

  1. Problema
    - La función get_public_web_page_by_slug usa https://agentedeseguros.online
    - El dominio correcto es https://agentedeseguros.website
    - Esto causa que las imágenes no se carguen correctamente

  2. Solución
    - Actualizar v_app_url a https://agentedeseguros.website
    - Esto corregirá las URLs de logos y fotos

  3. Cambios
    - Actualizar la función con el dominio correcto
*/
...
-- Comentario
COMMENT ON FUNCTION get_public_web_page_by_slug IS 'Obtiene los datos de la página pública de un asesor por su slug. Usa el dominio correcto agentedeseguros.website. SECURITY DEFINER para bypass de RLS.';
