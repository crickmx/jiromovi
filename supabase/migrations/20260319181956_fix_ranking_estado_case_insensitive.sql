/*
  # Corregir Función de Ranking - Case Insensitive para Estado

  1. Cambios
    - Actualizar fn_ranking_global para usar LOWER() en comparación de estado
    - Actualizar fn_ranking_oficina para usar LOWER() en comparación de estado
    - Hacer que las funciones sean insensibles a mayúsculas/minúsculas
*/
