/*
  # Fix calculate_batch_fiscal_aggregates to use usuario_id

  1. Problema
    - La función calculate_batch_fiscal_aggregates usa agent_id (línea 60)
    - Busca commission_agents (línea 74) que fue eliminada
    - Causa error: "column agent_id does not exist"

  2. Solución
    - Usar usuario_id directamente de commission_details
    - Eliminar búsqueda en commission_agents
    - Obtener régimen fiscal solo de usuarios.regimen_fiscal_id

  3. Simplificación
    - Ya no necesitamos buscar "régimen histórico" de commission_agents
    - Siempre usamos el régimen ACTUAL del usuario
*/
...
Fórmulas CSV V5: Ret IVA = (SinVida × 16) / 150, redondeo solo al final. ACTUALIZADO: usa usuario_id directamente.';