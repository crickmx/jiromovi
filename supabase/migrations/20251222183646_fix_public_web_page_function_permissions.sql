/*
  # Corregir Permisos de Función Pública

  1. Cambios
    - Cambiar función a SECURITY INVOKER para evitar problemas de permisos
    - Garantizar GRANT EXECUTE a anon y authenticated
    - Asegurar que la función sea completamente pública
*/

-- Recrear la función con SECURITY INVOKER
DROP FUNCTION IF EXISTS get_public_web_page_by_slug(text);
...
BEGIN
  ...
  SELECT json_build_object(
    'user', json_build_object(
      ...
      'phone', u.telefono_laboral,
      'photo_url', u.foto_perfil_url,
