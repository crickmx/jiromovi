/*
  # Fix: Normalizar Régimen Fiscal a Mayúsculas

  1. Changes
    - Guardar regimen_fiscal en MAYÚSCULAS para consistencia
*/
...
BEGIN
  ...
  -- Obtener régimen fiscal del usuario (normalizado a mayúsculas)
  SELECT 
...
-- Actualizar los lotes existentes para normalizar el régimen fiscal
UPDATE commission_batches
SET regimen_fiscal = UPPER(regimen_fiscal)
WHERE regimen_fiscal IS NOT NULL
  AND regimen_fiscal != UPPER(regimen_fiscal);
