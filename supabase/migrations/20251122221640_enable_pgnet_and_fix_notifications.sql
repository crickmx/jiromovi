/*
  # Habilitar pg_net y actualizar función de notificaciones

  1. Cambios
    - Habilitar extensión pg_net (para llamadas HTTP asíncronas)
    - Actualizar función para usar pg_net.http_post
    - Priorizar celular_laboral sobre celular_personal
    - Envío inmediato de notificaciones

  2. Notas
    - pg_net es la extensión recomendada por Supabase para HTTP
    - Las llamadas son asíncronas y no bloquean la transacción
*/

-- Habilitar extensión pg_net si no existe
CREATE EXTENSION IF NOT EXISTS pg_net WITH SCHEMA extensions;

-- Recrear función usando pg_net
