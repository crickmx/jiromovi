/*
  # Arreglar función get_user_full_context
  
  1. Cambios
     - Corregir referencia de regimen_fiscal a regimen_fiscal_id
     - Hacer join con commission_fiscal_regimes para obtener el nombre
  
  2. Seguridad
     - Mantiene SECURITY DEFINER existente
*/

-- Reemplazar función con la columna correcta
...
BEGIN
  ...
  SELECT
    ...
    u.rol,
    u.puesto,
    COALESCE(cfr.nombre, 'Sin régimen fiscal') as regimen_fiscal,
