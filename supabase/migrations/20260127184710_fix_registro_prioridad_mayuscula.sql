/*
  # Corregir prioridad de tickets en función de registro
  
  1. Cambios
    - Actualiza la función procesar_registro_no_usuario
    - Cambia 'alta' por 'Alta' para coincidir con el constraint de la tabla tickets
  
  2. Contexto
    - El constraint tickets_prioridad_check acepta: 'Alta', 'Media', 'Baja'
    - La función estaba usando 'alta' en minúsculas
    - Esto causaba error al intentar crear tickets desde el formulario de registro
*/

-- Actualizar función para usar 'Alta' en lugar de 'alta'
...
COMMENT ON FUNCTION procesar_registro_no_usuario IS 'Procesa registro de "Aún no soy usuario", crea tareas (tickets) con prioridad Alta y envía notificaciones';
