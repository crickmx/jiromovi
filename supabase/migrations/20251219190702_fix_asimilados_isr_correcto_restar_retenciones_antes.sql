/*
  # FIX ASIMILADOS: ISR correcto según Imagen 1 - RESTAR retenciones ANTES de /1.09
  ...
  IMPORTANTE: SÍ se restan las retenciones ANTES de dividir por 1.09
*/
...
- isrVida = ((vida - retContable) / 1.09) × 0.10 [SÍ restar retContable primero]
- isrDanios = ((sinVida - costoDispersion) / 1.09) × 0.10 [SÍ restar costoDispersion primero]
...
- isrVida debe ser $46.91
- isrDanios debe ser $1,308.61
