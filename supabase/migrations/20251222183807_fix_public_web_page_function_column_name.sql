/*
  # Corregir Nombre de Columna en Función Pública

  1. Cambios
    - Corregir id_oficina -> oficina_id en el JOIN
    - Mantener todos los permisos y características de SECURITY INVOKER
*/
