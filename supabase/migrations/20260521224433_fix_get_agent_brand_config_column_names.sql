/*
  # Fix get_agent_brand_config function column names
  ...
  2. Notes
    - The function was referencing non-existent columns causing NULL values
    - This ensures the public quote form displays the agent's actual brand colors and logo
*/
